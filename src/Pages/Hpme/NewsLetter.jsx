...
const NewsLetter = () => {
    ...
    return (
        ...
        <div className="hero min-h-[300px] lg:min-h-[500px]" style={{ backgroundImage: 'url(https://i.ibb.co/pyvgKSF/slide-1960x857-07.jpg)' }}>
            <div className="hero-overlay bg-opacity-60"></div>
            <div className="hero-content text-center text-neutral-content flex-col">
                <h1 className="mb-5 text-3xl font-bold">Subscribe for recent news</h1>
