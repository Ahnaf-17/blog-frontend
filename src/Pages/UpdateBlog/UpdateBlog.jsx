...
const UpdateBlog = () => {
    ...
    const { isLoading, data: AllBlog } = useQuery({
        queryKey: ['blogs'],
        queryFn: async () => {
            const res = await fetch('https://blog-server-rl5ch4hji-ahnaf-ahmeds-projects.vercel.app/blogs')
            return res.json()
        }
    })
    if(isLoading){
    ...
    const handleUpdateBlog = e =>{
        ...
        fetch(`https://blog-server-rl5ch4hji-ahnaf-ahmeds-projects.vercel.app/blogUpdate/${_id}`, {
            method: "PUT",
            headers: {
