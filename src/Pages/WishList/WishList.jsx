...
const WishList = () => {
    ...
    const { isLoading, data: wishlistBlog } =
        useQuery({
            ...
            queryFn: async () => {
                const res = await fetch(`https://blog-server-rl5ch4hji-ahnaf-ahmeds-projects.vercel.app/wishlist/${user.email}`)
    ...
    // useEffect(()=>{
    //     fetch(`https://blog-server-rl5ch4hji-ahnaf-ahmeds-projects.vercel.app/wishlist/${user.email}`)
    //     .then(res => res.json())
    //     .then(data => {
    ...
    const handleDeleteWishlist = (id) => {
        fetch(`https://blog-server-rl5ch4hji-ahnaf-ahmeds-projects.vercel.app/wishlist/${id}`, {
            method: "DELETE"
        })
            .then((res) => res.json())
            .then((data) => {
